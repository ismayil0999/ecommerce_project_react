...
import { Carts, CartItem, CartInfo, CartTitle, CartImg, CartContainer, CartHead, CartButtons,EmptyFavorite,TotalDiv } from "../styled";
...
export default function Card() {
  const { cart, setshowCart,item, removeToCart, decrement, increment } = useProductContext();
...
setTotal(t)
  ...
  return (
    <CartContainer >
      ...
      <TotalDiv><h3>Total:  {total}</h3> <AttachMoneyIcon/></TotalDiv>
    </CartContainer>
  );
}
