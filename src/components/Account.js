  ...
  return (
    ...
    <h4>Your profile</h4>
     ...
     <UserInfo>
         ...
         <h3>Charles Peprah</h3>
         <p>Phone: 0123456789</p>
         <p>Email: example@user.com</p>
         <p>Adress: example adress, street</p>
     </UserInfo>
<TabHeader>
<div value="1" onClick={()=>ChangeToggle(1)} className={toggle===1 ? "active-tab" : "tab"}>Profil</div>
<div onClick={()=>ChangeToggle(2)}  className={toggle===2 ? "active-tab" : "tab"}>Adress</div>
<div onClick={()=>ChangeToggle(3)}  className={toggle===3 ? "active-tab" : "tab"}>Orders</div>
</TabHeader>
